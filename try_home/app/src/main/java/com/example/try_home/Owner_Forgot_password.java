...
public class Owner_Forgot_password extends AppCompatActivity {
    String OTP;
...
/*
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (b == true)
                {
                    ...
                    //Toast.makeText(Owner_Forgot_password.this,b.toString(),Toast.LENGTH_SHORT).show();
                    if (res)
                    {
                        btn_send.setText("Resend OTP");
                        Toast.makeText(Owner_Forgot_password.this, "OTP sent", Toast.LENGTH_SHORT).show();

                        send_mail(ed_email.getText().toString());


                        Intent i = new Intent(getApplicationContext(), Enter_otp.class);
                        i.putExtra("pass_for_otp", OTP);
                        i.putExtra("pass_for_email", ed_email.getText().toString());
                        startActivity(i);

                    } else
                        Toast.makeText(Owner_Forgot_password.this, "Email not registered", Toast.LENGTH_SHORT).show();
                }
                else
                    Toast.makeText(Owner_Forgot_password.this, "Email Format is inappropriate", Toast.LENGTH_SHORT).show();
            }
            ...
            try {
               ...
               // Transport.send(m);
                Thread t=new Thread(new Runnable() {
                 ...
                 //           Toast.makeText(Owner_Forgot_password.this, e.toString(), Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Owner_Forgot_password.this, "not sent", Toast.LENGTH_SHORT).show();
    ...
    {
        SqlOp obj=new SqlOp(Owner_Forgot_password.this);
        Boolean c=obj.Owner_Check_email(email);
        return c;
    }

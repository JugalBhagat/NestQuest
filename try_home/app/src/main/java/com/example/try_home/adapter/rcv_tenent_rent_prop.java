...
public class rcv_tenent_rent_prop extends RecyclerView.Adapter<rcv_tenent_rent_prop.ViewHolder> {
    ...
    public rcv_tenent_rent_prop(Context context, List list,String state,String city,String furn,String ptype,String bhk,int min_price,long max_price) {
    ...
    public rcv_tenent_rent_prop(Context context, List list,String state,String city,String area)
    {
        this.context = context;
        this.list = list;
        this.state=state;
    ...
    @Override
    //what to show(card)
    public rcv_tenent_rent_prop.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull rcv_tenent_rent_prop.ViewHolder holder, int position) {
        ...
        ArrayList al=x.get_rent_prop_data(position,state,city,area);

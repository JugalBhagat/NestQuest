...
public class desc_rcv_tenent_rent extends RecyclerView.Adapter<desc_rcv_tenent_rent.ViewHolder> {
    ...
    public desc_rcv_tenent_rent(Context context, List list,String state,String city,String furn,String ptype,String bhk,int min_price,long max_price) {
    ...
    public desc_rcv_tenent_rent(Context context, List list,String state,String city,String area)
    {
        this.context = context;
        this.list = list;
        this.state=state;
    ...
    @Override
    //what to show(card)
    public desc_rcv_tenent_rent.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.rent_card_view,parent,false);
        return new ViewHolder(v);
    }

    @Override
    //what to do after i get viewholder obj
    public void onBindViewHolder(@NonNull desc_rcv_tenent_rent.ViewHolder holder, int position) {
        ...
        ArrayList al=x.desc_get_rent_prop_data(position,state,city,area);
        ...
        holder.tv_rent.setText(String.valueOf(al.get(3))+" ₹");
        holder.tv_deposite.setText(String.valueOf(al.get(4))+" ₹");
        holder.tv_prop_type.setText(String.valueOf(al.get(5)));
        Cursor c=x.get_rent_prop_data_img(String.valueOf(al.get(0)));
        c.moveToFirst();
        ...
        holder.con_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("prop_detail_variable_what","Rent");
    ...
    public int getItemCount() {
        SqlOp x=new SqlOp(context.getApplicationContext());
        Cursor c=x.get_prop_rent_data_count(state,city,area);
        return c.getCount();
    }

    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        TextView tv_bhk_type,tv_address,tv_rent,tv_prop_type,tv_deposite,tv_nearby;
        ImageView img_pic1;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tv_rent=itemView.findViewById(R.id.txt_rent);
            tv_deposite=itemView.findViewById(R.id.txt_deposite);

...
public class desc_rcv_tenent_sell extends RecyclerView.Adapter<desc_rcv_tenent_sell.ViewHolder> {
    ...
    public desc_rcv_tenent_sell(Context context, List list,String state,String city,String area) {
        this.context = context;
        this.list = list;
        this.state=state;
        this.city=city;
    }
    public desc_rcv_tenent_sell(Context context, List list,String state,String city,String furn,String ptype,String bhk,int min_price,long max_price) {
        this.context = context;
        this.list = list;
        this.state=state;
        this.city=city;
    ...
    @Override
    //what to show(card)
    public desc_rcv_tenent_sell.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull desc_rcv_tenent_sell.ViewHolder holder, int position) {
        ...
        //x.del_acc_owner();
        ArrayList al=x.desc_get_sell_prop_data(position,state,city,area);
